...
header : Header.Logo -> List Header.NavItem -> Maybe Header.User -> Bool -> Html Header.Msg
header logo navBar user showSearchBar =
    Header.view { logo = logo, navBar = navBar, user = user, showSearchBar = showSearchBar }
