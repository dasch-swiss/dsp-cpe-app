module Modules.NavigationHeader.HeaderModule exposing (..)

import Html exposing (div, img, nav)
import Html.Attributes exposing (class, id, src)
import Modules.NavigationHeader.NavbarModule exposing (NavBar, navBar)
import Modules.NavigationHeader.SearchBar exposing (searchBar)
import Modules.NavigationHeader.UserMenuModule exposing (User, userMenu)
import Util.CustomCss.DaschTailwind as Dtw exposing (classList)


view : String -> Maybe User -> NavBar msg -> Bool -> Html.Html msg
view logo user bar showSb =
