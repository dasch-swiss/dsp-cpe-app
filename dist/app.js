...
{
	if (region.ag.K === region.aq.K)
	{
		return 'on line ' + region.ag.K;
	}
	return 'on lines ' + region.ag.K + ' through ' + region.aq.K;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {as: fragment, ax: host, aE: path, aG: port_, aJ: protocol, aK: query};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{a4: false, a6: r.a6, be: r.be, av: r.av, bm: r.bm, bJ: r.bJ, aZ: r.aZ, t: r.t}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{a6: $elm$http$Http$emptyBody, be: r.be, av: _List_Nil, bm: 'GET', bJ: $elm$core$Maybe$Nothing, aZ: $elm$core$Maybe$Nothing, t: r.t});
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$PhotoGroove$Photo = F3(
	function (url, size, title) {
		return {aS: size, aY: title, t: url};
	});
...
var $author$project$PhotoGroove$initialCmd = $elm$http$Http$get(
	{
		...
		t: 'https://elm-in-action.com/photos/list.json'
	});
var $author$project$PhotoGroove$Loading = {$: 0};
var $author$project$PhotoGroove$Medium = 1;
var $author$project$PhotoGroove$initialModel = {H: '', U: 1, J: 5, L: 5, O: 5, g: $author$project$PhotoGroove$Loading};
			...
			case 0:
				...
				return $author$project$PhotoGroove$applyFilters(
					_Utils_update(
						model,
						{
							g: A2($author$project$PhotoGroove$selectUrl, url, model.g)
						}));
			case 1:
				var size = msg.a;
				return _Utils_Tuple2(
			...
			case 6:
				...
				return $author$project$PhotoGroove$applyFilters(
					_Utils_update(
						model,
						{
							g: A2($author$project$PhotoGroove$selectUrl, photo.t, model.g)
						}));
			case 7:
				if (!msg.a.$) {
					var photos = msg.a.a;
					if (photos.b) {
						...
						return $author$project$PhotoGroove$applyFilters(
							_Utils_update(
								model,
								{
									g: A2($author$project$PhotoGroove$Loaded, photos, first.t)
								}));
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									g: $author$project$PhotoGroove$Errored('0 photos found')
								}),
							$elm$core$Platform$Cmd$none);
					}
				} else {
					switch (msg.a.a.$) {
						case 0:
							var errorMessage = msg.a.a.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										g: $author$project$PhotoGroove$Errored('BadUrl: ' + errorMessage)
									}),
								$elm$core$Platform$Cmd$none);
						case 1:
							var _v4 = msg.a.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										g: $author$project$PhotoGroove$Errored('Timeout')
									}),
								$elm$core$Platform$Cmd$none);
						case 2:
							var _v5 = msg.a.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										g: $author$project$PhotoGroove$Errored('NetworkError')
									}),
								$elm$core$Platform$Cmd$none);
						case 3:
							var errorMessage = msg.a.a.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										g: $author$project$PhotoGroove$Errored(
											'BadStatus: ' + $elm$core$String$fromInt(errorMessage))
									}),
								$elm$core$Platform$Cmd$none);
						default:
							var errorMessage = msg.a.a.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										g: $author$project$PhotoGroove$Errored('BadBody: ' + errorMessage)
									}),
								$elm$core$Platform$Cmd$none);
					}
				}
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					thumb.aY + (' [' + ($elm$core$String$fromInt(thumb.aS) + ' KB]'))),
