...
primary : Html msg
primary =
    Button.primaryButtonUnStyled [] "Primary Button" BasicExtraSmall
...
secondary : Html msg
secondary =
    Button.secondaryButtonUnStyled [] "Secondary Button" BasicExtraSmall
...
white : Html msg
white =
    Button.whiteButtonUnstyled [] "White Button" BasicExtraSmall
...
circular : Html msg
circular =
    Button.circularButtonUnstyled [] Icon.AcademicCap CircularLarge
